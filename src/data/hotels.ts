...
export const HOTEL_BLOCKS: HotelCityBlock[] = [
  ...
  },
  {
    id: 'wuhan-crrc',
    city: 'Wuhan',
    venue: 'CRRC Yangtze / automotive rail ops sites — confirm host address for daily transfers',
    venueLat: 30.5928,
    venueLng: 114.3055,
    summary:
      'Prefer international 4–5★ in Wuchang / Hankou CBD with van access to CRRC Yangtze and loading sites (typically 30–60 min by car depending on plant). Confirm exact site with host before booking.',
    hotels: [
      {
        name: 'Shangri-La Wuhan',
        brand: 'Shangri-La',
        stars: '5',
        address: 'No. 700 Jianshe Avenue, Jianghan District',
        travelToVenue: '~40–60 min by car to CRRC Yangtze area (traffic dependent)',
        lat: 30.5845,
        lng: 114.2712,
        approx: true,
        usdMin: 90,
        ...
        myrMax: usdToMyr(200),
        withinUsd120: true,
        notes: 'Strong international 5★ default for mixed ITaLI+DDE group.',
        url: 'https://www.shangri-la.com/wuhan/shangrila/',
      },
      {
        name: 'Hilton Wuhan Optics Valley',
        brand: 'Hilton',
        stars: '5',
        address: 'Optics Valley / East Lake Hi-Tech area',
        travelToVenue: '~30–50 min by car depending on CRRC site',
        lat: 30.4785,
        lng: 114.3985,
        approx: true,
        usdMin: 80,
        ...
        myrMax: usdToMyr(180),
        withinUsd120: true,
        notes: 'Convenient if programme sits toward Optics Valley / southeast Wuhan.',
      },
      {
        name: 'Holiday Inn Wuhan Riverside',
        brand: 'IHG · Holiday Inn',
        stars: '4',
        address: 'Riverside / Hankou area',
        travelToVenue: '~40–60 min by car to plant sites',
        lat: 30.5712,
        lng: 114.2955,
        approx: true,
        usdMin: 55,
        ...
        myrMax: usdToMyr(130),
        withinUsd120: true,
        notes: 'International 4★; usually fits ~USD 120 planning band.',
      },
      {
        name: 'Mercure Wuhan Optics Valley',
        brand: 'Accor · Mercure',
        stars: '4',
        address: 'Optics Valley area',
        travelToVenue: '~30–50 min by car depending on site',
        lat: 30.4855,
        lng: 114.4055,
        approx: true,
        usdMin: 50,
        ...
        myrMax: usdToMyr(120),
        withinUsd120: true,
        notes: 'Select-service international 4★; confirm English desk for group check-in.',
      },
    ],
  },
]
...
export const HOTEL_NOTES = [
  ...
  'Wuhan: confirm CRRC Yangtze / loading-site address with host; budget daily group vans (HSR Liuzhou→Wuhan is ~5h).',
